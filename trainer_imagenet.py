...
parser.add_argument('data', metavar='DIR', nargs='?', default='/opt/scratch/imagenet', # Add your imagenet dataset
...
parser.add_argument('--epochs', default=300, type=int, metavar='N',  # early stopped around 210
...
parser.add_argument('--eps', dest='eps',help='Input variation parameter',type=float, default=0.015)
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer, args.epochs-args.warm_up*4, eta_min = 0, last_epoch= -1, verbose=False)
